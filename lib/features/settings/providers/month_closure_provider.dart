...
final monthClosuresProvider =
    StreamProvider.autoDispose<List<MonthClosureEvent>>((ref) {
      return ref.watch(monthClosureRepositoryProvider).watchMonthClosures();
    });

final latestMonthClosureProvider =
    Provider.autoDispose<AsyncValue<MonthClosureEvent?>>((ref) {
...
final unreadMonthClosureProvider =
    FutureProvider.autoDispose<MonthClosureEvent?>((ref) async {
