...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,techId,techName,companyId,companyName,invoiceNumber,clientName,clientContact,const DeepCollectionEquality().hash(acUnits),status,expenses,expenseNote,adminNote,const DeepCollectionEquality().hash(importMeta),approvedBy,isSharedInstall,sharedInstallGroupKey,sharedInvoiceTotalUnits,sharedContributionUnits,sharedInvoiceSplitUnits,sharedInvoiceWindowUnits,sharedInvoiceFreestandingUnits,sharedInvoiceBracketCount,sharedDeliveryTeamCount,sharedInvoiceDeliveryAmount,techSplitShare,techWindowShare,techFreestandingShare,techBracketShare,charges,date,submittedAt,reviewedAt]);

@override
String toString() {
  return 'JobModel(id: $id, techId: $techId, techName: $techName, companyId: $companyId, companyName: $companyName, invoiceNumber: $invoiceNumber, clientName: $clientName, clientContact: $clientContact, acUnits: $acUnits, status: $status, expenses: $expenses, expenseNote: $expenseNote, adminNote: $adminNote, importMeta: $importMeta, approvedBy: $approvedBy, isSharedInstall: $isSharedInstall, sharedInstallGroupKey: $sharedInstallGroupKey, sharedInvoiceTotalUnits: $sharedInvoiceTotalUnits, sharedContributionUnits: $sharedContributionUnits, sharedInvoiceSplitUnits: $sharedInvoiceSplitUnits, sharedInvoiceWindowUnits: $sharedInvoiceWindowUnits, sharedInvoiceFreestandingUnits: $sharedInvoiceFreestandingUnits, sharedInvoiceBracketCount: $sharedInvoiceBracketCount, sharedDeliveryTeamCount: $sharedDeliveryTeamCount, sharedInvoiceDeliveryAmount: $sharedInvoiceDeliveryAmount, techSplitShare: $techSplitShare, techWindowShare: $techWindowShare, techFreestandingShare: $techFreestandingShare, techBracketShare: $techBracketShare, charges: $charges, date: $date, submittedAt: $submittedAt, reviewedAt: $reviewedAt)';
}
...
@useResult
$Res call({
 String id, String techId, String techName, String companyId, String companyName, String invoiceNumber, String clientName, String clientContact, List<AcUnit> acUnits, JobStatus status, double expenses, String expenseNote, String adminNote, Map<String, dynamic> importMeta, String? approvedBy, bool isSharedInstall, String sharedInstallGroupKey, int sharedInvoiceTotalUnits, int sharedContributionUnits, int sharedInvoiceSplitUnits, int sharedInvoiceWindowUnits, int sharedInvoiceFreestandingUnits, int sharedInvoiceBracketCount, int sharedDeliveryTeamCount, double sharedInvoiceDeliveryAmount, int techSplitShare, int techWindowShare, int techFreestandingShare, int techBracketShare, InvoiceCharges? charges,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? date,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? submittedAt,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? reviewedAt
});
...
class _JobModel implements JobModel {
  const _JobModel({this.id = '', required this.techId, required this.techName, this.companyId = '', this.companyName = '', required this.invoiceNumber, required this.clientName, this.clientContact = '', final  List<AcUnit> acUnits = const <AcUnit>[], this.status = JobStatus.pending, this.expenses = 0.0, this.expenseNote = '', this.adminNote = '', final  Map<String, dynamic> importMeta = const <String, dynamic>{}, this.approvedBy, this.isSharedInstall = false, this.sharedInstallGroupKey = '', this.sharedInvoiceTotalUnits = 0, this.sharedContributionUnits = 0, this.sharedInvoiceSplitUnits = 0, this.sharedInvoiceWindowUnits = 0, this.sharedInvoiceFreestandingUnits = 0, this.sharedInvoiceBracketCount = 0, this.sharedDeliveryTeamCount = 0, this.sharedInvoiceDeliveryAmount = 0.0, this.techSplitShare = 0, this.techWindowShare = 0, this.techFreestandingShare = 0, this.techBracketShare = 0, this.charges, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) this.date, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) this.submittedAt, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) this.reviewedAt}): _acUnits = acUnits,_importMeta = importMeta;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,techId,techName,companyId,companyName,invoiceNumber,clientName,clientContact,const DeepCollectionEquality().hash(_acUnits),status,expenses,expenseNote,adminNote,const DeepCollectionEquality().hash(_importMeta),approvedBy,isSharedInstall,sharedInstallGroupKey,sharedInvoiceTotalUnits,sharedContributionUnits,sharedInvoiceSplitUnits,sharedInvoiceWindowUnits,sharedInvoiceFreestandingUnits,sharedInvoiceBracketCount,sharedDeliveryTeamCount,sharedInvoiceDeliveryAmount,techSplitShare,techWindowShare,techFreestandingShare,techBracketShare,charges,date,submittedAt,reviewedAt]);
