...
as int,settlementAdminNote: null == settlementAdminNote ? _self.settlementAdminNote : settlementAdminNote // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,techId,techName,companyId,companyName,invoiceNumber,clientName,clientContact,const DeepCollectionEquality().hash(_acUnits),status,expenses,expenseNote,adminNote,settlementStatus,settlementBatchId,settlementRound,settlementAdminNote,settlementTechnicianComment,settlementRequestedBy,const DeepCollectionEquality().hash(_importMeta),approvedBy,isSharedInstall,sharedInstallGroupKey,sharedInvoiceTotalUnits,sharedContributionUnits,sharedInvoiceSplitUnits,sharedInvoiceWindowUnits,sharedInvoiceFreestandingUnits,sharedInvoiceUninstallSplitUnits,sharedInvoiceUninstallWindowUnits,sharedInvoiceUninstallFreestandingUnits,sharedInvoiceBracketCount,sharedDeliveryTeamCount,sharedInvoiceDeliveryAmount,techSplitShare,techWindowShare,techFreestandingShare,techUninstallSplitShare,techUninstallWindowShare,techUninstallFreestandingShare,techBracketShare,charges,date,submittedAt,reviewedAt,settlementRequestedAt,settlementRespondedAt,settlementCorrectedAt]);
