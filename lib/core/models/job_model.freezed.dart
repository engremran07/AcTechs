...
as DateTime?,adminEditedBy: freezed == adminEditedBy ? _self.adminEditedBy : adminEditedBy // ignore: cast_nullable_to_non_nullable
as String?,adminEditedAt: freezed == adminEditedAt ? _self.adminEditedAt : adminEditedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,transferredFromTechId: null == transferredFromTechId ? _self.transferredFromTechId : transferredFromTechId // ignore: cast_nullable_to_non_nullable
as String,transferredFromTechName: null == transferredFromTechName ? _self.transferredFromTechName : transferredFromTechName // ignore: cast_nullable_to_non_nullable
as String,transferredAt: freezed == transferredAt ? _self.transferredAt : transferredAt // ignore: cast_nullable_to_non_nullable
as DateTime?,transferredByAdminId: null == transferredByAdminId ? _self.transferredByAdminId : transferredByAdminId // ignore: cast_nullable_to_non_nullable
as String,transferStatus: null == transferStatus ? _self.transferStatus : transferStatus // ignore: cast_nullable_to_non_nullable
as String,transferTargetTechId: null == transferTargetTechId ? _self.transferTargetTechId : transferTargetTechId // ignore: cast_nullable_to_non_nullable
as String,transferTargetTechName: null == transferTargetTechName ? _self.transferTargetTechName : transferTargetTechName // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of JobModel
...
@override final  String? adminEditedBy;
@override@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) final  DateTime? adminEditedAt;
// Job transfer audit trail (admin-only operation)
@override@JsonKey() final  String transferredFromTechId;
@override@JsonKey() final  String transferredFromTechName;
@override@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) final  DateTime? transferredAt;
@override@JsonKey() final  String transferredByAdminId;
// Tech-initiated transfer request fields
@override@JsonKey() final  String transferStatus;
@override@JsonKey() final  String transferTargetTechId;
@override@JsonKey() final  String transferTargetTechName;
