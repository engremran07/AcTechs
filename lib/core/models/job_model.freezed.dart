...
mixin _$JobModel {
 ...
 String get id; String get techId; String get techName; String get companyId; String get companyName; String get invoiceNumber; String get clientName; String get clientContact; List<AcUnit> get acUnits; JobStatus get status; double get expenses; String get expenseNote; String get adminNote; Map<String, dynamic> get importMeta; String get approvedBy; bool get isSharedInstall; String get sharedInstallGroupKey; int get sharedInvoiceTotalUnits; int get sharedContributionUnits; int get sharedInvoiceSplitUnits; int get sharedInvoiceWindowUnits; int get sharedInvoiceFreestandingUnits; int get sharedDeliveryTeamCount; double get sharedInvoiceDeliveryAmount;/// Additional invoice charges (bracket, delivery).
...
as double,charges: freezed == charges ? _self.charges : charges // ignore: cast_nullable_to_non_nullable
...
class _JobModel implements JobModel {
  const _JobModel({this.id = '', required this.techId, required this.techName, this.companyId = '', this.companyName = '', required this.invoiceNumber, required this.clientName, this.clientContact = '', final  List<AcUnit> acUnits = const <AcUnit>[], this.status = JobStatus.pending, this.expenses = 0.0, this.expenseNote = '', this.adminNote = '', final  Map<String, dynamic> importMeta = const <String, dynamic>{}, this.approvedBy = '', this.isSharedInstall = false, this.sharedInstallGroupKey = '', this.sharedInvoiceTotalUnits = 0, this.sharedContributionUnits = 0, this.sharedInvoiceSplitUnits = 0, this.sharedInvoiceWindowUnits = 0, this.sharedInvoiceFreestandingUnits = 0, this.sharedDeliveryTeamCount = 0, this.sharedInvoiceDeliveryAmount = 0.0, this.charges, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) this.date, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) this.submittedAt, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) this.reviewedAt}): _acUnits = acUnits,_importMeta = importMeta;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,techId,techName,companyId,companyName,invoiceNumber,clientName,clientContact,const DeepCollectionEquality().hash(_acUnits),status,expenses,expenseNote,adminNote,const DeepCollectionEquality().hash(_importMeta),approvedBy,isSharedInstall,sharedInstallGroupKey,sharedInvoiceTotalUnits,sharedContributionUnits,sharedInvoiceSplitUnits,sharedInvoiceWindowUnits,sharedInvoiceFreestandingUnits,sharedDeliveryTeamCount,sharedInvoiceDeliveryAmount,charges,date,submittedAt,reviewedAt]);
